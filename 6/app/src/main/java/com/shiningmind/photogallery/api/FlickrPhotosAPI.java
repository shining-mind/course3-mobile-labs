...
public interface FlickrPhotosAPI {
    @GET("services/rest/?method=flickr.photos.getRecent&format=json&nojsoncallback=1&perpage=10")
    Call<PhotosResponse> getRecent(@Query("api_key") String apiKey);
    @GET("services/rest/?method=flickr.photos.search&format=json&nojsoncallback=1&perpage=10")
