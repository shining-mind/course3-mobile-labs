...
public class PhotosResponseUnitTest {
    ...
    {
        Gson gson = new Gson();
        PhotosResponse photosResponse = gson.fromJson("{" +
                "  \"photos\": {" +
                "    \"page\": 1," +
                "    \"pages\": \"334\"," +
                "    \"perpage\": 3," +
                ...
                "  }," +
                "  \"stat\": \"ok\"" +
                "}", PhotosResponse.class);
        assertEquals(photosResponse.getStat(), "ok");
        assertEquals(photosResponse.getPhotos().getPhoto().size(), 3);
        Photo photo1 = photosResponse.getPhotos().getPhoto().get(0);
        ...
        Photo photo2 = photosResponse.getPhotos().getPhoto().get(1);
        ...
        Photo photo3 = photosResponse.getPhotos().getPhoto().get(2);
